...
public abstract class _Painting extends BaseDataObject {
    ...
    public static final EntityProperty<Gallery> PAINTINGS = PropertyFactory.createEntity("paintings", Gallery.class);
    ...
    public void setPaintings(Gallery paintings) {
        setToOneTarget("paintings", paintings, true);
    }

    public Gallery getPaintings() {
        return (Gallery)readProperty("paintings");
    }
